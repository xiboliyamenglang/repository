                ...
                <div class="panel-body">
                    <form role="form" class="form-inline">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="unassignedRoleList" multiple size="10" style="width:100px;overflow-y:auto;">
                        ...
                        <div class="form-group" style="margin-left:40px;">
                            ...
                            <select class="form-control" id="assignedRoleList" multiple size="10" style="width:100px;overflow-y:auto;">

                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <h3 class="break">
                                    <a href="${APP_PATH}/project/project.html">活性富氢净水直饮机</a>
                                </h3>
                                <p>
                    ...
                    <div class="col-md-3">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <h3 class="break">
                                    <a href="${APP_PATH}/project/project.html">酷驰触控龙头，智享厨房黑科技</a>
                                </h3>
                                <p>
                                <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
                    ...
                    <div class="col-md-3">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <h3 class="break">
                                    <a href="${APP_PATH}/project/project.html">小熊猫鱼眼全景安防摄像机</a>
                                </h3>
                                <p>
                                <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
                    ...
                    <div class="col-md-3">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <h3 class="break">
                                    <a href="${APP_PATH}/project/project.html">一款精致的机械表</a>
                                </h3>
                                <p>
                                <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>

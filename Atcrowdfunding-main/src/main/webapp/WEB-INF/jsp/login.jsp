      ...
      <form id="loginForm" method="post" action="${APP_PATH }/doLogin.do"  name="loginForm" class="form-signin" role="form">
        <h2 class="form-signin-heading"><i class="glyphicon glyphicon-log-in"></i> 用户登录</h2>
		  <div class="form-group has-success has-feedback">
			<input type="text" id="loginacct" name="loginacct" placeholder="请输入登录账号"  class="form-control" autofocus>
			<span class="glyphicon glyphicon-user form-control-feedback"></span>
		  </div>
		  <div class="form-group has-success has-feedback">
			<input type="password" id="userpswd" name="userpswd" placeholder="请输入登录密码" class="form-control" style="margin-top:10px;">
